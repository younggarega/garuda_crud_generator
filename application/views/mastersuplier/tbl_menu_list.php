                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                        <div style="padding-bottom: 10px;"'>
                            ...
                            <?php echo anchor(site_url('mastersuplier/word'), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Export Ms Word', 'class="btn btn-primary btn-sm"'); ?>
                            <?php echo anchor(site_url('mastersuplier/pdf'), '<i class="btn btn-danger btn-sm "> Export To PDF</i>',array('target'=>'_blank')); ?>
                            </div>
