...
class Laporan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template','laporan/tbl_menu_list',$data);
    }
    ...
    public function read($id) 
    {
		...
		'is_aktif' => $row->is_aktif,
            ...
            $this->template->load('template','laporan/tbl_menu_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','laporan/tbl_menu_form', $data);
    }
    ...
    public function word()
    {
        ...
        $this->load->view('laporan/tbl_menu_doc',$data);
    }
