...
class Barangmasuk_model extends CI_Model
{
    ...
    public $table = 'tbl_komponen_masuk';
    public $id = 'id_masuk';
    public $order = 'DESC';
    ...
    // datatables
    function json() {
        $this->datatables->select('id_masuk,tgl_masuk,id_komponen,stock_masuk');
        $this->datatables->from('tbl_komponen_masuk');
